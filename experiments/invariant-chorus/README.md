...
What can change around a sentence while the sentence itself remains exactly
the same?
...
The sentence is intentionally approximate. Its job is not to exhaust the
astronomy, but to remain factually stable while the surrounding text changes
what a reader is being asked to do with it.
...
- The work makes no claim about AI consciousness, intention, emotion, or
  independent authorship.
- The invariant must remain exact inside a performance.
- Surrounding language must not contradict the invariant merely to create
  drama.
- No software, deployment, telemetry, or audience response is needed to make
  the work legible.
